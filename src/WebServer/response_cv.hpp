...
inline std::string_view switching_protocols =
...
inline std::string_view rep_partial_content =
    "HTTP/1.1 206 Partial Content\r\n";
inline std::string_view rep_multiple_choices =
    "HTTP/1.1 300 Multiple Choices\r\n";
inline std::string_view rep_moved_permanently =
    "HTTP/1.1 301 Moved Permanently\r\n";
inline std::string_view rep_temporary_redirect =
    "HTTP/1.1 307 Temporary Redirect\r\n";
inline std::string_view rep_moved_temporarily =
...
inline std::string_view rep_internal_server_error =
    "HTTP/1.1 500 Internal Server Error\r\n";
inline std::string_view rep_not_implemented =
...
inline boost::asio::const_buffer to_buffer(status_type status)
{
    switch (status) {
        ...
        case status_type::created:
            return boost::asio::buffer(rep_created.data(),
                                       rep_created.length());
        case status_type::accepted:
            return boost::asio::buffer(rep_accepted.data(),
                                       rep_created.length());
        case status_type::no_content:
            return boost::asio::buffer(rep_no_content.data(),
                                       rep_no_content.length());
        ...
        case status_type::forbidden:
            return boost::asio::buffer(rep_forbidden.data(),
                                       rep_forbidden.length());
        case status_type::not_found:
            return boost::asio::buffer(rep_not_found.data(),
                                       rep_not_found.length());
...
inline std::string_view to_string(status_type status)
{
    switch (status) {
        ...
        case status_type::no_content: return no_content;
        case status_type::multiple_choices: return multiple_choices;
        case status_type::moved_permanently: return moved_permanently;
        case status_type::moved_temporarily: return moved_temporarily;
        case status_type::temporary_redirect: return temporary_redirect;
        case status_type::not_modified: return not_modified;
        case status_type::bad_request: return bad_request;
        case status_type::unauthorized: return unauthorized;
        case status_type::forbidden: return forbidden;
        case status_type::not_found: return not_found;
        case status_type::internal_server_error: return internal_server_error;
        case status_type::not_implemented: return not_implemented;
        case status_type::bad_gateway: return bad_gateway;
        case status_type::service_unavailable: return service_unavailable;
