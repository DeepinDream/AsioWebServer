...
namespace AsioWeb {
enum class res_content_type { html, json, string, multipart, none };
...
static std::map<AsioWeb::res_content_type, std::string_view> res_mime_map = {
    {AsioWeb::res_content_type::html, "text/html; charset=utf8"},
    {AsioWeb::res_content_type::json, "application/json; charset=utf8"},
    {AsioWeb::res_content_type::string, "text/plain; charset=utf8"},
    {AsioWeb::res_content_type::multipart, "multipart/form-data; boundary="}};
