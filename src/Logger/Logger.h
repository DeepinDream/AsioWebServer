...
#define LOG_INFO if(LogLevel::INFO <= Logger::getLogLevel()) _LOG_(LogLevel::INFO)
#define LOG_WANRING if(LogLevel::WARNING <= Logger::getLogLevel()) _LOG_(LogLevel::WARNING)
#define LOG_ERROR if(LogLevel::ERROR <= Logger::getLogLevel()) _LOG_(LogLevel::ERROR)